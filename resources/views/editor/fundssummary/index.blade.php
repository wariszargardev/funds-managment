            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ __('Funds list') }}
                        <form method="get" action="{{route('editor.funds.export')}}">
                                ...
                                <tbody>
                                    @foreach($funds as $fund)
                                        <tr>
                                            ...
                                            <td><a style="text-decoration: none" href="{{ route('editor.funds.show.all',$fund->user->id) }}" >{{ $fund->user->phone_number??'' }}</a></td>
                                            ...
                                            <td>{{ $fund->city }}</td>
                                            <td>{{ $fund->country }}</td>
                                            <td><a href="{{ route('editor.fundsdetails.show',$fund->id) }}" class="btn btn-outline-primary">Show</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
