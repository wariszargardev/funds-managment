            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-outline-info float-end" href="{{route('editor.funds.export')}}">Excel Download</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a style="text-decoration: none " @class('btn btn-outline-info') href="{{ route('editor.funds.show.all',$user->id) }}" >  Show </a>                                              {{ $fund->user->phone_number??'' }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
